...
exports.SET_CURRENT_DOCUMENT = 'SET_CURRENT_DOCUMENT';
exports.setCurrentDocument = function (index) { return ({
    type: exports.SET_CURRENT_DOCUMENT,
    index: index,
}); };
